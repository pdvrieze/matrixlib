...
public interface IntMatrix : Matrix<Int>, SparseIntMatrix {
    public fun toFlatArray(): IntArray
    public fun contentEquals(other: IntMatrix): Boolean
    ...
    public companion object : ImmutableMatrixCompanion<Int> {
         ...
         */
        public operator fun invoke(width: Int, height: Int, initValue: Int): IntMatrix {
