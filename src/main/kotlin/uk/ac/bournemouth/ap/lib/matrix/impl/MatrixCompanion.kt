 ...
 * @suppress
 */
public interface MatrixCompanion<B> {
    /**
     ...
     */
    public operator fun <T : B> invoke(original: Matrix<T>): Matrix<Any?>
     ...
     */
    public operator fun <T : B> invoke(width: Int, height: Int, initValue: T): Matrix<Any?>
     ...
     */
    public operator fun <T : B> invoke(width: Int, height: Int, init: (Int, Int) -> T): Matrix<Any?>
}